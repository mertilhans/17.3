...
/*   Updated: 2025/08/19 16:17:16 by merilhan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int process_command(t_parser *cmd, t_exec_data *data, t_env **env_list)
{
    ...
    // Sonraki komut için pipe'ı hazırla
    if (cmd->next && data->pipefd[0] != -1)
    {
        // Write ucu zaten fork_pipe_exec'de kapatıldı
